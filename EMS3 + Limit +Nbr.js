...
var limitSource = prompt("Choose limit mode:\n1 = Total from limit.txt (split across tabs)\n2 = Per-tab from Nbr.txt", "2");

// === CONFIGURATION PARAMETERS ===
var Limit_File = "limit.txt";        // File containing total limits per hour
var Nbr_File = "Nbr.txt";            // File containing exact limits per tab
var batch = 3;                       // Batch size
var delay = 3000;                    // Delay in milliseconds
var tabsCount = 8;                   // Number of tabs to use
